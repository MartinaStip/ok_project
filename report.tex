...
% title page
\makeatletter
\renewcommand*{\titlepagetopskip}{0pt} % mezera nad titulem na titlepage
\makeatother
...
\urlstyle{same}
\hypersetup{
  pdftitle={ Report 2025},
  pdfauthor={Martina Štípková; Gabriela Fatková; František Kalvas; Lenka Půtová; Natálie Bečvářová},
  pdflang={cs},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\title{\includegraphics[width=\paperwidth]{background.jpg} Report 2025}
\author{Martina Štípková \and Gabriela Fatková \and František
Kalvas \and Lenka Půtová \and Natálie Bečvářová}
\date{}
\begin{document}
\maketitle
